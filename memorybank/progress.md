...
Next: add CSV filter to skip blank metadata rows before telemetry diff; rerun staging backfill/diff with instrumentation counters to confirm missing windows close; document results and confidence adjustments upon validation.
